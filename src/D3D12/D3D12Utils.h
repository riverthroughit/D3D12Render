...
inline void SetDebugName(_In_ ID3D12DeviceChild* resource, _In_z_ const wchar_t(&name)[NameLength]) noexcept
{
...
inline UIntPoint GeTextureSize(ID3D12Resource* Texture)
{
